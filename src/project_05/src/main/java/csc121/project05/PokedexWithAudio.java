...
public class PokedexWithAudio {
	...
	// Audio clip for Pokemon descriptions
	Clip clip;

	
	public static void main(String[] args) {
		loadData();
		SwingUtilities.invokeLater(() -> new PokedexWithAudio().build());
	}
	...
	public void setAudio(int number)
	{
		...
		try
		{
			if (clip != null) if(clip.isActive()) clip.close();
