...
public class BongoBurgerMenu_copy {
    ...
    public static void main (String[] args) {
        ...
        String spicy = "Spiciness Levels:\n";
        String spicyLevels = " ";
        spicyLevels =  "    1.Mild + $0.00    2.%-10s + $%6.2f%n    3.%-10s + $%6.2f%n    4.%-10s + $%6.2f%n";
        spicyLevels += "    1.Medium + $%6.2f%n    2.%-10s + $%6.2f%n    3.%-10s + $%6.2f%n    4.%-10s + $%6.2f%n";
        spicyLevels += "    1.%-10s + $%6.2f%n    2.%-10s + $%6.2f%n    3.%-10s + $%6.2f%n    4.%-10s + $%6.2f%n";
        spicyLevels += "    1.%-10s + $%6.2f%n    2.%-10s + $%6.2f%n    3.%-10s + $%6.2f%n    4.%-10s + $%6.2f%n";
